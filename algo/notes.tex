...
\section{Algebraic computation trees: examples}
\section{Distinctness problem: upper bound}
\section{Connected components of semialgebraic sets}
\section{Lower bound for membership to a semialgebraic set: decision computation trees}
\section{Thom-Milnor’s bound}
\section{Lower bound for membership to a semialgebraic set: algebraic computation trees}
\section{Distinctness problem: lower bound}
